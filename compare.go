...
func initRegexps() {
	allRegexps["email3"] = `([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x22([^\x0d\x22\x5c\x80-\xff]|\x5c[\x00-\x7f])*\x22)(\x2e([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x22([^\x0d\x22\x5c\x80-\xff]|\x5c[\x00-\x7f])*\x22))*\x40([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x5b([^\x0d\x5b-\x5d\x80-\xff]|\x5c[\x00-\x7f])*\x5d)(\x2e([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x5b([^\x0d\x5b-\x5d\x80-\xff]|\x5c[\x00-\x7f])*\x5d))*`

	allRegexps["ssn"] = `\d{3}-\d{2}-\d{4}`
	allRegexps["passport"] = `\d{4}\s\d{6}`
	allRegexps["snils"] = `\d{3}-\d{3}-\d{3} \d{2}`
	//allRegexps["fio"] = `([А-ЯЁ][а-яё]+[\-\s]?){3,}`
	allRegexps["bitcoin1"] = `\b([13][a-km-zA-HJ-NP-Z1-9]{25,34}|bc1[ac-hj-np-zAC-HJ-NP-Z02-9]{11,71})`
	allRegexps["bitcoin2"] = `[13][a-km-zA-HJ-NP-Z1-9]{25,34}`

	allRegexps["email0"] = `[\w\.+-]+@[\w\.-]+\.[\w\.-]+`
	allRegexps["email1"] = `[a-z0-9_\.-]+\@[\da-z\.-]+\.[a-z\.]{2,6}`
	//allRegexps["email2"] = `(?P<name>[-\w\d\.]+?)(?:\s+at\s+|\s*@\s*|\s*(?:[\[\]@]){3}\s*)(?P<host>[-\w\d\.]*?)\s*(?:dot|\.|(?:[\[\]dot\.]){3,5})\s*(?P<domain>\w+)`
